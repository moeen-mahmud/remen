...
export default function RichEditor({
    ...
    const handleSelectionChangeEvent = (e: TextInputSelectionChangeEvent) => {
        setSelection({
        ...
        if (animatedScrollViewRef.current) {
            ...
            requestAnimationFrame(() => {
                ...
                const estimatedLines = content.split("\n").slice(0, Math.floor(selection?.start ?? 0 / 50)).length;
                ...
                const visibleAreaHeight = Dimensions.get("window").height - bottom - 120; // approximate screen height, adjust as needed
