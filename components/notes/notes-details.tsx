...
import { getNoteById, getTagsForNote, updateNote, type Note, type Tag } from "@/lib/database/database";
import { findRelatedNotes, type SearchResult } from "@/lib/search/search";
