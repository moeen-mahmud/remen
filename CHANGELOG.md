...
- 94fece2: - NEW FEATURE: Contextual Recall
    - Replaced SMOLLM2.1 360M Quantized with LLAMA3.2 1B Spinquant
    - Redesigned the model lifecycle for the AI pipeline
    - Improved the AI Queue process
    - Cut the OCR feature, and simplified the scan flow
    - Improved Semantic and NLP search
    - Fixed task type note taking
    - Added auto sync for the notes to the iCloud

## 0.1.2

### Patch Changes

- e066e25: ### Fixes and UI Improvements
    - removed border radius from image container
    - removed padding from image container
    - removed border from the title edit component
    - removed animation pulse while processing the note

## 0.1.0

### Minor Changes

- 9f93065: **Notes & editor**
    - Create and edit notes (text only)
    - Text editor with auto-save
    - Pin, archive, trash; swipe actions (pin, archive, trash, permanent delete from trash)
...
- tagline sh release bot implemented ([#19](https://github.com/moeen-mahmud/remen/pull/19))
